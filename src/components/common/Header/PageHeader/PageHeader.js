...
<div className='container signup-header'>
         ...
         :path.split('/')[1]==='forgotpasswordcheckmail'?(<div className='forgotcheckmail'><h3 style={{fontWeight:500}}>Check your email</h3><p>A security code to reset your password was sent to your email address</p><p className='two-fact-validate'>If no email is received within ten minutes,please check your email spam folder,try again,or contact our help number</p></div>)
