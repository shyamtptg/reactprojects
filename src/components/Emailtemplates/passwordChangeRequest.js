                ...
                <table style={{width: '600px', 
                    ...
                    <tr>
                        <td style={{fontSize:'16px',
                                    ...
                                    fontWeight:'bold',
                                    color:'#333',
                                    paddingTop:'10px'}}>Password change request</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style={{color:'#555555',
                                    ...
                                    lineHeight: '20px',
                                    padding:'20px 0px'}}>
                            If you did not attempt to reset your password, please <Link to='' style={{textDecoration:'none',
                                                color:'#7979fd'}}>contact us immediately.</Link><br/>
